...
Write a summary paragraph describing what you observed and how it relates to the central limit theorem.
    ...
    I observed that as the sample size grew, the data began centralizing towards the middle and forming a single positive half of a sine wave. While the mean seemed to remain the same throughout the tests, the standard deviation began shrinking slightly.
